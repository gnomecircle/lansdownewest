const workshops = {
  ...
  fr: {
    ...
    hsep: {
      ...
      goals: ["Instructeur d'expérience", 'Petits groupes', 'Évaluations'],
      instructor: '',
      langOffered: ['anglais et français'],
      grade: '6e année',
      price: "Appelez pour plus d'informations.",
      schedule: [
        // {
        //   date: 'Sam. Sept 23',
        //   time: '9h to 13h',
    ...
    history: {
      ...
      description:
        "Le but de cet atelier est de préparer les élèves à réussir l'examen prototype du ministère.",
      goals: [
